...
| ✅ v1.2 | Visual Editing | Thao tác 2 chiều ngang app cùng loại — DONE 2026-07-10 (DGC-17..87) | done |
...
| v2.0 SD Studio | 🔶 Phase A+B ✅ 2026-07-13 | Compare mode, collapse, C4 drill-down breadcrumb (không cần đổi grammar). Kế: Phase C coach+what-if — đề xuất contract annotations chờ Đô |
